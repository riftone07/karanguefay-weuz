...
! function (t, e) {
  ...
  var optionsone = {
    ...
    series: [{
      name: "$",
      data: [0, 10, 40, 30, 45, 60, 70, 100, 90]
    }],
    fill: {
    ...
    xaxis: {
      ...
      categories: ['Mar 23', 'Mar 24', 'Mar 25', 'Mar 26', 'Mar 27', 'Mar 28', 'Mar 29'],
      labels: {
        show: true,
        style: {
          colors: ['#1E266D', '#1E266D', '#1E266D', '#1E266D', '#1E266D', '#1E266D', '#1E266D'],
          fontSize: '14px',
        },
      }
    },
    ...
    yaxis: {
      ...
      categories: ['0.00', '10.00', '20.00', '30.00', '40.00', '50.00', '60.00' ],
      labels: {
        show: true,
        style: {
  ...
  if (document.querySelector('#chart') !== null) {
    var chart = new ApexCharts(document.querySelector("#chart"), optionsone);
    chart.render();
  }
